/**
 * Created by xiangzhihong on 2017/5/11.
 */
'use strict';
import {observable, computed, asMap, autorun} from 'mobx';
import Weather from '../model/WeatherInfo';
import {ListView} from 'react-native';
import AirItemInfo from '../model/AirItemInfo';
import SuggestionItemInfo from  '../model/SuggestionItemInfo'
import CityItemInfo from '../model/WeatherItemInfo'
...
class WeatherStore {
    ...
    convertAqiToList(weatherData) {
        ...
        this.aqiList.push(new AirItemInfo('O³', aqi.o3, '臭氧', 'μg/m³'));
        this.aqiList.push(new AirItemInfo('PM10', aqi.pm10, '可吸入颗粒物', 'μg/m²'));
        this.aqiList.push(new AirItemInfo('PM2.5', aqi.pm25, '可入肺颗粒', 'μg/m³'));
    ...
    convertSuggestionList(weatherData) {
        ...
        this.lifeList.push(new SuggestionItemInfo('舒适指数', suggestion.comf.brf, suggestion.comf.txt));
        this.lifeList.push(new SuggestionItemInfo('洗车指数', suggestion.cw.brf, suggestion.cw.txt));
        this.lifeList.push(new SuggestionItemInfo('穿衣指数', suggestion.drsg.brf, suggestion.drsg.txt));
        this.lifeList.push(new SuggestionItemInfo('感冒指数', suggestion.flu.brf, suggestion.flu.txt));
        this.lifeList.push(new SuggestionItemInfo('运动指数', suggestion.sport.brf, suggestion.sport.txt));
        this.lifeList.push(new SuggestionItemInfo('旅游指数', suggestion.trav.brf, suggestion.trav.txt));
        this.lifeList.push(new SuggestionItemInfo('紫外线指数', suggestion.uv.brf, suggestion.uv.txt));
    }
